...
This is the corrected v9 release.
...
- Live one-line progress display.

Python 3.9–3.12 compatible, tested against Gmail IMAP SSL.
"""
...
def main():
    ...
    if not hasattr(args, "list_folders"):
        raise AssertionError("Internal bug: args.list_folders missing")
    ...
    if args.list_folders:
        ...
        for kind, name in mailboxes:
            ...
            print(f"  {safe_display_name(name):30s}  {count:8d}  ({kind or 'normal'})")
        M.logout()
        return

...
- Uses SELECT with readonly= for dry-run (fixed wrapper supports kwargs).
- No dependency on 'imap4-utf-7' codec.
...
def delete_in_mailbox(
    ...
    # Dry-run: SELECT read-only; destructive: SELECT read-write
